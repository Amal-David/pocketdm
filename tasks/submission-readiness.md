...
- Pikachu is persistent across the native macOS overlay, uses four local 3D mood sprite strips, gives state-aware hints, includes compact native chat, plays subtle original chirps, and switches between Happy, Nap, Hyper, and Alert reactions.
